function initengahan(){
  ...
  function tombol(){wallpaper.style="transform: scale(1);";Tombol.style="opacity:1;transform: scale(1);";if(fungsi==2){By.innerHTML="&#128140; Hết rùi"}}
  ...
  else if(waktuSekarang < 19){ucapan = "Good evening, ";}
